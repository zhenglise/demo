                    ...
                    if(data.length > 0){
                        ...
                        for(index in data) {
                            ...
                            var trdata = "<tr><td style=\"text-align: center;\">" + index + "</td>" +
                                ...
                                "<td class=\"center\" style=\"text-align: center;\">" + data[index].userCode + "</td>" +
                                "<td class=\"center\" style=\"text-align: center;\">" + data[index].aboutMeun + "</td></tr>";
                    ...
                    <div class="box-content">
                        ...
                        <form id="selectForm" action="#" method="post">
                            ...
                            <div class="dataTables_filter">
                                <label>
                                    账号: <input type="text" id="userCode">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable">
                            ...
                            <tr id="trId">
                                ...
                                <th style="width: 40px;text-align: center;" id="userName">账号CODE</th>
                                <th style="width: 40px;text-align: center;" >权限值</th>
                            </tr>
                            </thead>
                            <tbody id="showListTr">
