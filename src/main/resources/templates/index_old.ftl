			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<#--<li><a class="ajax-link" href="index.ftl"><i class="icon-home"></i><span class="hidden-tablet"> Dashboard</span></a></li>-->
						...
						<li><a class="ajax-link" onclick='clickMenu("showTypography");'><i class="icon-font"></i><span class="hidden-tablet"> Typography</span></a></li>
						<li><a class="ajax-link" onclick='clickMenu("showTable");'><i class="icon-align-justify"></i><span class="hidden-tablet"> Tables</span></a></li>
						<li><a class="ajax-link" onclick='clickMenu("showCalendar");'><i class="icon-calendar"></i><span class="hidden-tablet"> Calendar</span></a></li>
						<li><a class="ajax-link" onclick='clickMenu("showIcon");'><i class="icon-star"></i><span class="hidden-tablet"> Icons</span></a></li>
						<li><a href="error.html"><i class="icon-ban-circle"></i><span class="hidden-tablet"> Error Page</span></a></li>
						<li><a onclick='clickMenu("showlogin");'><i class="icon-lock"></i><span class="hidden-tablet"> Login Page</span></a></li>
					</ul>
