	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.ftl"> <img alt="Charisma Logo" src="img/logo20.png" /> <span>Charisma</span></a>
			...
			<div class="row-fluid sortable">
				<div class="box span12 tour">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-globe"></i> 修改员工</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						...
						员工名称 <input type="text" name="userName" value="${user.userName}">
						员工部门 <input type="text" name="department" value="${user.department}">
